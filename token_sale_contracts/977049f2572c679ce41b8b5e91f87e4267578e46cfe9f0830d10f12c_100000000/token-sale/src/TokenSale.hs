...
validator = Scripts.validatorScript (typedValidator ts)
    where ts = TokenSaleParams { tsSellerAddress  = pubKeyHashAddress "977049f2572c679ce41b8b5e91f87e4267578e46cfe9f0830d10f12c" -- put in the seller address here
                               , tsCost           = 100000000                          -- Price for the token in lovelace
                               }
