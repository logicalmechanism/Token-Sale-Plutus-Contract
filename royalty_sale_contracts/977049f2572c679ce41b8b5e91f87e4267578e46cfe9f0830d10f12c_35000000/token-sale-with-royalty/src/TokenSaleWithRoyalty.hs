...
validator = Scripts.validatorScript (typedValidator ts)
    where ts = TokenSaleParams { tsSellerAddress  = pubKeyHashAddress "977049f2572c679ce41b8b5e91f87e4267578e46cfe9f0830d10f12c" -- update to new seller
                               , tsRoyaltyAddress = pubKeyHashAddress "cd4d860bb6be9239aaf8a7562962585b3f401f01f8f22d623480c3ff" -- get original seller
