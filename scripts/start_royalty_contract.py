...
def start_royalty(tmp, wallet_skey_path, wallet_addr, script_addr, datum_hash, collateral):
    """
    This allows the seller to place a token to be sold into a royalty smart contract.
    """
...
if __name__ == "__main__":
    ...
    start_royalty(TMP, SELLER_SKEY_PATH, SELLER_ADDR, SCRIPT_ADDR, DATUM_HASH, COLLATERAL)